...
class DisponibilidadController extends Controller
{
    ...
    public function __invoke(Request $request, int $id): JsonResponse
    {
        ...
        $suscripcionSuspendida = (bool) ($disponibilidad['suscripcion_suspendida'] ?? false);
        ...
        return response()->json([
            ...
            'precio_con_luz' => $cancha->precio_con_luz ? (float) $cancha->precio_con_luz : null,
            'iluminacion' => (bool) $cancha->iluminacion,
            'hora_inicio_luz' => $disponibilidad['hora_inicio_luz'] ?? ($cancha->complejo?->hora_inicio_luz ?? '19:00'),

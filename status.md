...
- **Fase Actual:** Proyecto SaaS Finalizado & Certificado para Producción (Suspensión de reservas online y marketplace por abono vencido con reactivación inmediata por acreditación de pago; corrección y unificación multimoneda de comisiones de marketplace de reservas en ARS convertidas a USD para el abono B2B; buscador manual con geocodificación OSM Nominatim y radio de 200 km; alta de canchas excedentes con alerta interactiva; facturación B2B y comisiones de marketplace; período de gracia de 7 días; visibilidad de contraseña en checkout online; Padrón y Ficha 360° de Clientes; protocolo por lluvia y tarifas dinámicas)
- **Última Actualización:** 2026-09-22 (Suspensión técnica de reservas y funciones operativas ante abonos vencidos con levantamiento automático reactivo al acreditarse el pago. 439 tests automatizados en verde: 290 backend, 129 frontend, 20 mobile; 100% sin fallas ni regresiones).

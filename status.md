...
- **Última Actualización:** 2026-09-21 (Formateo de fechas a dd-mm-aaaa en el detalle de turnos de marketplace y tabla de facturas B2B en FacturacionClubPanel; conversión matemática de comisiones originadas en turnos en ARS a USD en ClubBillingService. 432 tests automatizados en verde: 286 backend, 126 frontend, 20 mobile; 100% sin fallas ni regresiones).
